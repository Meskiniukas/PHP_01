...
session_start();
 ...
 if(isset($_GET) && count($_POST) != 0){
    header('Location: http://localhost/barsukas/ND0610/ND0610-10.php/?kiek='.count($_POST)); 
    die;
 }
...
if (isset($_GET['kiek']) && isset($_SESSION['generuota'])){
    ...
    echo '<form action="http://localhost/barsukas/ND0610/ND0610-10.php/" method="post">';
    $letters='ABCDEFGHIJ';
