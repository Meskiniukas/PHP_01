...
header("Location: http://localhost/barsukas/ND0610/ND0610-11.php?name1=" . $_GET['name1'] . "&name2=" . $_GET['name2'] . '&rolled=0');
die;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/barsukas/ND0610/ND0610-11style.css">
</head>
<body >
    <header>
    ...
    if(!isset($_GET['name1']) and !isset($_GET['name2'])){
        echo '<div>
        <form action="http://localhost/barsukas/ND0610/ND0610-11.php/" method="get">
        ...
        <button type="submit" class="btn btn-primary">PRADĖTI</button>
            ...
            if(($_SESSION['score1'] ?? 0) >= 30 or ($_SESSION['score2'] ?? 0) >= 30){
                ...
                session_destroy();
                echo '<a href="http://localhost/barsukas/ND0610/ND0610-11.php/"class="btn btn-primary">Rinktis kitus žaidėjus</a>';
                echo '</div>';
             }
        }
   ?>
