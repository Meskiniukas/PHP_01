...
<body>
    <form action="http://localhost/barsukas/ND0610/ND0610-6.php/" method="get">
    <button type="submit">GET button</button>
    </form>
    <form action="http://localhost/barsukas/ND0610/ND0610-6.php/" method="post">
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    //  header('Location: http://localhost/barsukas/ND0610/ND0610-6.php/'); // get
    //  die;
 }